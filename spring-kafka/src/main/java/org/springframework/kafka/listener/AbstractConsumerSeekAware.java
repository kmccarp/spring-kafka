...
public abstract class AbstractConsumerSeekAware implements ConsumerSeekAware {
	...
	public void seekToBeginning() {
		getCallbacksAndTopics().forEach(ConsumerSeekAware.ConsumerSeekCallback::seekToBeginning);
	}
	...
	public void seekToEnd() {
		getCallbacksAndTopics().forEach(ConsumerSeekAware.ConsumerSeekCallback::seekToEnd);
	}
