...
public class ExistingRetryTopicIntegrationTests {
	...
	public static final String RETRY_TOPIC_WITH_NO_PARTITION_INFO = "main-topic-1-retry-0";

	public static final String MAIN_TOPIC_WITH_PARTITION_INFO = "main-topic-2";

	public static final String RETRY_TOPIC_WITH_PARTITION_INFO = "main-topic-2-retry-0";
